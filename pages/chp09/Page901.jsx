...
const sys={...React.sys};
const rowheight=42;
export default class Page901 extends MyFormComponent {
  state={
    myTable1:{
      data: [],  //某一页数据
      total: 0,  //行总数
  ...
  render() {
    ...
    */
    ...
    return (<>
      <Layout style={{overflow:'hidden'}}>
        <Header style={{ padding:0, paddingLeft:4, height: 35, lineHeight:'30px', backgroundColor: '#E0ECFF', borderBottom:'1px solid #95B8E7', overflow:'hidden'}}>
          <Form name='filterbar'>
            ...
            <AntdInputBox type='search' id='filtertext' label='快速过滤' labelwidth='72' top='2' left='260' width='350' ref={ref => this.filtertext = ref} onSearch={this.handleSearchFilter.bind(this)} />
          </Form>
        </Header>
      ...
      <ConfirmModal ref={ref => this.myDeleteModal = ref} onConfirm={(e)=>this.handleDeleteRow(this.state.myTable1.row, this.state.myTable1.rowindex)} />
    </>)
  }
}
